...
<html lang="zxx">
    <head>
        ...
        <!--====== Title ======-->
        <title>Vision, Mission, Values & Motto - Multiplex Group</title>
        <!--====== Favicon Icon ======-->
    ...
    <body>
        ...
        <section class="features-section" style="background-color:#f6d0a259; padding:18px;margin:20px;">
                ...
                <div class="row align-items-xl-center">
                        <div class="col-xl-8 col-lg-12">
                            ...
                            <div class="vm-text">
                                ...
                                <p class="wow fadeInDown" data-wow-delay=".6s">We are an ISO 9001 and ISO 14001 certified company known for their quality
								standards. Both our Bio-Fertilizers and Bio-Pesticides are certified by IMO Switzerland for use in organic farming.</p>
                            </div>
                        </div>
						<div class="col-xl-4 col-lg-12">
                            <!--=== Hero Image Box ===-->
                            <div class="hero-image-box d-xl-block wow fadeInRight" data-wow-delay=".75s">
                                <img src="assets/images/what-we-do.png" alt="Hero Image">
                            </div>
                        </div>
                </div>
			</div>
		 ...
		 <section class="features-section" style="padding:18px;margin:20px;">
			<div class="container">
                <div class="row align-items-xl-center vm-bg-color">
                        <div class="col-xl-4 col-lg-12">
                            <!--=== Hero Image Box ===-->
                            <div class="hero-image-box d-xl-block wow fadeInRight" data-wow-delay=".75s">
                                <img src="assets/images/what-we-do-1.png" alt="Hero Image">
                            </div>
                        </div>
						<div class="col-xl-8 col-lg-12">
                            <!--=== Hero Content ===-->
                            <div class="vm-text">
                                ...
                                <p class="wow fadeInDown" data-wow-delay=".6s">We are one of the leading manufacturers, marketers and exporters of Micro 
                ...
                <div class="row align-items-xl-center">
                        <div class="col-xl-8 col-lg-12">
                            ...
                            <div class="vm-text">
                                ...
                                <p class="wow fadeInDown" data-wow-delay=".6s">To progressively research and develop innovative products and services to the farming community.</p>
                            </div>
                        </div>
						<div class="col-xl-4 col-lg-12">
                            <!--=== Hero Image Box ===-->
                            <div class="hero-image-box d-xl-block wow fadeInRight" data-wow-delay=".75s">
                                <img src="assets/images/vision.png" alt="Hero Image">
                            </div>
                        </div>
                </div>
			</div>
			...
			<div class="container">
                <div class="row align-items-xl-center">
                        <div class="col-xl-4 col-lg-12">
                            <!--=== Hero Image Box ===-->
                            <div class="hero-image-box d-xl-block wow fadeInRight" data-wow-delay=".75s">
                                <img src="assets/images/mission.png" alt="Hero Image">
                            </div>
                        </div>
						<div class="col-xl-8 col-lg-12">
                            <!--=== Hero Content ===-->
                            <div class="vm-text">
                                <h2 class="wow fadeInUp" data-wow-delay=".4s">Our Mission</h2>
                                <p class="wow fadeInDown" data-wow-delay=".6s">To be the most preferred quality Agri Input manufacturer and supplier to achieve “Total Solution provider” in improving overall soil health, crop productivity and quality of the produce.</p>
                            </div>
                        </div>
                </div>
			</div>
                ...
                <div class="row align-items-xl-center">
                        <div class="col-xl-8 col-lg-12">
                            ...
                            <div class="vm-text">
                                ...
                                <p class="wow fadeInDown" data-wow-delay=".6s">Integrity, Quality, Trust, Transparency, Commitment, Relationship, and Innovation.</p>
                            </div>
                        </div>
						<div class="col-xl-4 col-lg-12">
                            <!--=== Hero Image Box ===-->
                            <div class="hero-image-box d-xl-block wow fadeInRight" data-wow-delay=".75s">
                                <img src="assets/images/values.png" alt="Hero Image">
                            </div>
                        </div>
                </div>
			</div>
			...
			<div class="container">
                <div class="row align-items-xl-center">
                        <div class="col-xl-4 col-lg-12">
                            <!--=== Hero Image Box ===-->
                            <div class="hero-image-box d-xl-block wow fadeInRight" data-wow-delay=".75s">
                                <img src="assets/images/motto1.png" alt="Hero Image">
                            </div>
                        </div>
						<div class="col-xl-8 col-lg-12">
                            <!--=== Hero Content ===-->
