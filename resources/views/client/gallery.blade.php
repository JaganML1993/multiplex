...
<html lang="zxx">
    <head>
        ...
        <!--====== Title ======-->
        <title>Gallery - Multiplex Group</title>
        <!--====== Favicon Icon ======-->
                    ...
                    <div class="col-lg-4 col-sm-6 order-lg-1">
                        ...
                        <div class="masonry-project-item mb-30 wow fadeInUp">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall1.jpg" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 order-lg-2">
                        <!--====== Gallery Item ======-->
                        <div class="masonry-project-item mb-30 wow fadeInDown">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall2.jpg" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 order-lg-3 order-sm-8">
                        <!--====== Gallery Item ======-->
                        <div class="masonry-project-item mb-30 wow fadeInUp">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall3.png" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12 order-lg-4">
                        <!--====== Gallery Item ======-->
                        <div class="masonry-project-item mb-30 wow fadeInLeft">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall4.png" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12 order-lg-5">
                        <!--====== Gallery Item ======-->
                        <div class="masonry-project-item mb-30 wow fadeInRight">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall5.png" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 order-lg-6 order-sm-6 wow fadeInDown">
                        <!--====== Gallery Item ======-->
                        <div class="masonry-project-item mb-30">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall6.png" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-12 order-lg-7 order-sm-5">
                        <!--====== Gallery Item ======-->
                        <div class="masonry-project-item mb-30 wow fadeInUp">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall7.jpg" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 order-lg-8 order-sm-7">
                        <!--====== Gallery Item ======-->
                        <div class="masonry-project-item mb-30 wow fadeInDown">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall8.jpg" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
					<div class="col-lg-4 col-sm-6 order-lg-6 order-sm-6 wow fadeInDown">
                        ...
                        <div class="masonry-project-item mb-30">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall9.jpg" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-12 order-lg-7 order-sm-5">
                        ...
                        <div class="masonry-project-item mb-30 wow fadeInUp">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall10.png" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
					 <div class="col-lg-4 col-sm-12 order-lg-7 order-sm-5">
                        ...
                        <div class="masonry-project-item mb-30 wow fadeInUp">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall11.png" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
					<div class="col-lg-4 col-sm-6 order-lg-6 order-sm-6 wow fadeInDown">
                        ...
                        <div class="masonry-project-item mb-30">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall12.png" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-12 order-lg-7 order-sm-5">
                        ...
                        <div class="masonry-project-item mb-30 wow fadeInUp">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall13.jpg" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
					 <div class="col-lg-4 col-sm-12 order-lg-7 order-sm-5">
                        ...
                        <div class="masonry-project-item mb-30 wow fadeInUp">
                            <div class="project-img">
                                <img src="assets/images/gallery/gall14.jpg" alt="Gallery Image">
                            </div>
                        </div>
                    </div>
