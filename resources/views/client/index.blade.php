...
<section class="banner-section banner-section-home home-banner-desktop" style="background-image: url({{ asset('images/home-banner-1920x929-new.webp') }});background-repeat: no-repeat; background-size: cover; background-position: center; min-height:565px;">
    <!--=== Hero Wrapper ===-->
...
<section class="banner-section banner-section-home home-banner-mobile" style="background-image: url({{ asset('images/home-banner-1920x929-new.webp') }});background-repeat: no-repeat; background-size: cover; background-position: center; min-height:565px;">
    <!--=== Hero Wrapper ===-->
    <div class="hero-wrapper-one gray-bg1">
        <div class="container">
            <div class="row align-items-lg-center">
...
<section class="trigger section gutter-horizontal bg-dark-home-goc gutter-vertical--m gutter-horizontal pt-50 pb-50">
    ...
    <div class="customer-logos slider">
        ...
        alt="Mystique Apparels India Pvt. Ltd"></a>
    </div> --}}
            ...
            <div class="container">
                <div class="row align-items-xl-center">
                    ...
                    <div class="col-xl-3 col-lg-12 text-dark text-center">
                        ...
                        <br />
                        <div class="about-two_image-box wow fadeInLeft">
                            <a href="https://play.google.com/store/apps/details?id=com.elevatozloyalty.sambrama&pli=1" target="_blank"><img src="{{ asset('images/playstore-logo.png') }}" alt="" class="in-img"></a>
                        </div>
                    </div>
                </div>
            </div>
