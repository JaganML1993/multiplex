...
<html lang="zxx">
    <head>
        ...
        <!--====== Title ======-->
        <title>Job Application - Multiplex Group</title>
        <!--====== Favicon Icon ======-->
                                ...
                                <div class="accordion-card mb-15">
                                    ...
                                    <div id="collapse0" class="accordion-collapse collapse show" data-parent="#accordionOne">
                                        <div class="accordion-body">
                                            <p>We are seeking a motivated and results-driven Sales Representative to join our dynamic sales team.
											As a Sales Representative, you will be responsible for identifying potential customers, promoting our 
											products or services, and securing new business opportunities. You will play a crucial role in driving 
											revenue growth, building strong relationships with clients, and achieving sales targets.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-card mb-15">
                                    ...
                                    <div id="collapse1" class="accordion-collapse collapse" data-parent="#accordionOne">
                                        <div class="accordion-body">
                                            <li>Prospecting and Lead Generation: Identify and research potential customers in the assigned market segment. 
											Utilize various methods such as cold calling, networking, attending events, and leveraging online platforms to 
											generate leads.</li>
											<li>Sales Presentations: Conduct persuasive and engaging product or service presentations to prospects, showcasing
											the unique features and benefits of our offerings.</li>
											<li>Customer Relationship Management: Build and maintain strong, long-lasting customer relationships. 
											Understand the needs and requirements of clients and offer suitable solutions to address their challenges.</li>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-card mb-15">
                                    ...
                                    <div id="collapse2" class="accordion-collapse collapse" data-parent="#accordionOne">
                                        <div class="accordion-body">
                                            <li>Proven work experience as a Sales Representative or relevant role.</li>
											<li>Excellent communication and interpersonal skills.</li>
											<li>Strong persuasive and negotiation abilities.</li>
                                    ...
                                    <form class="review-form">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
											 ...
											 <div class="col-lg-6">
                                                <div class="form_group">
                                                    <input type="text" class="form_control" placeholder="Position Applying" name="job" required disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form_group">
                                                    <input type="text" class="form_control" placeholder="Job Location" name="jobloc" required disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form_group">
												    <!-- <label for="resumeFile">Upload Resume</label> -->
                                                    <input type="file" id="resumeFile" class="form_control" placeholder="Job Location" name="resumeFile" required >
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form_group">
                                                    <button class="main-btn primary-btn">Submit Application</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
