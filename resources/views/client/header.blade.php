...
<body>
                            ...
                            <div class="col-xl-12 col-lg-12 sidebar-widget">
                                <div class="description-wrapper mt-30">
                                    ...
                                    <div class="review-form-area mt-10 mb-10">
                                        ...
                                        <form class="review-form general-form" id="review-form" onsubmit="return validateForm()" method="post"
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="text" id="verification_code" name="verification_code"
                                                    pattern="\d{4}" title="Please enter a 4-digit number" required>
    ...
    <script>
        // Generate and set a random 4-digit number for the verification code
        var randomCode = Math.floor(1000 + Math.random() * 9000);
        // Display the random number next to the label
         ...
         function validateForm() {
            ...
            if(enteredCode != ''){
                if (enteredCode == randomCode) {
                    // Codes match, allow form submission
                    return true;
                } else {
                    // Codes don't match, prevent form submission
