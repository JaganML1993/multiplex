...
<html lang="zxx">
    <head>
        ...
        <!--====== Title ======-->
        <title>Current Openings - Multiplex Group</title>
        <!--====== Favicon Icon ======-->
			   ...
			   <div class="row text-center">
			       <div class="col-xl-12 col-md-12">
				         <p>Sorem ipsum dolor sit amet, consectetur adipiscing elit. Tortor nulla id neque scelerisque pulvinar.
						   amet interdum turpis consequat adipiscing. Elementum feugiat sed duis consectetur varius et cras mattis. 
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-md-6">
                        ...
                        <div class="single-info-item style-three mb-40 wow fadeInUp">
                            <div class="shape shape-one"><span><img src="assets/images/info-shape-2.png" alt="shape"></span></div>
                            <div class="info">
                                <span><i class="fa-solid fa-location-dot"></i> Karnataka</span>
                                <h4 class="title">Sales Representative</h4>
								<span>Vacancies: 8</span>
								<br/>
                                 <a href="job-application.html" class="main-btn primary-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        ...
                        <div class="single-info-item style-three mb-40 wow fadeInUp">
                            <div class="shape shape-one"><span><img src="assets/images/info-shape-2.png" alt="shape"></span></div>
                            <div class="info">
                                <span><i class="fa-solid fa-location-dot"></i> Maharashtra</span>
                                <h4 class="title">Sales Officer</h4>
								<span>Vacancies: 10</span><br/>
                                 <a href="#" class="main-btn primary-btn">View Details</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        ...
                        <div class="single-info-item style-three mb-40 wow fadeInUp">
                            ...
                            <div class="info">
                                <span><i class="fa-solid fa-location-dot"></i> Karnataka</span>
                                <h4 class="title">Accounts Executive</h4>
								<span>Vacancies: 3</span><br/>
                                 <a href="#" class="main-btn primary-btn">View Details</a>
                            </div>
                        </div>
                    </div>
					 <div class="col-xl-4 col-md-6">
                        ...
                        <div class="single-info-item style-three mb-40 wow fadeInUp">
                            <div class="shape shape-one"><span><img src="assets/images/info-shape-2.png" alt="shape"></span></div>
                            <div class="info">
                                <span><i class="fa-solid fa-location-dot"></i> Gujarat</span>
                                <h4 class="title">Accounts Executive</h4>
								<span>Vacancies: 3</span><br/>
                                 <a href="#" class="main-btn primary-btn">View Details</a>
                            </div>
					 ...
					 <div class="col-xl-4 col-md-6">
                        ...
                        <div class="single-info-item style-three mb-40 wow fadeInUp">
                            <div class="shape shape-one"><span><img src="assets/images/info-shape-2.png" alt="shape"></span></div>
                            <div class="info">
                                <span><i class="fa-solid fa-location-dot"></i> Tamil Nadu</span>
                                <h4 class="title">Accounts Executive</h4>
								<span>Vacancies: 3</span><br/>
                                 <a href="#" class="main-btn primary-btn">View Details</a>
                            </div>
					 ...
					 <div class="col-xl-4 col-md-6">
                        ...
                        <div class="single-info-item style-three mb-40 wow fadeInUp">
                            <div class="shape shape-one"><span><img src="assets/images/info-shape-2.png" alt="shape"></span></div>
                            <div class="info">
                                <span><i class="fa-solid fa-location-dot"></i> Bihar</span>
                                <h4 class="title">Accounts Executive</h4>
								<span>Vacancies: 3</span><br/>
                                 <a href="#" class="main-btn primary-btn">View Details</a>
                            </div>
