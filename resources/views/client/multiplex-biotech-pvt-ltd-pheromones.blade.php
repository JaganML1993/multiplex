...
<section class="page-title-area text-white bg_cover desktop-view"
    ...
    <div class="container">
        ...
        <div class="page-title-inner text-center">
            <h1 class="page-title">Multiplex Biotech Pvt Ltd (Pheromones) </h1>
            <div class="gd-breadcrumb">
                <span class="breadcrumb-entry"><a href="{{ url('/') }}">Home</a></span>
                <span class="separator"></span>
                <span class="breadcrumb-entry active">Multiplex Biotech Pvt Ltd (Pheromones) </span>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12">
                    ...
                    <div class="section-title mb-25">
                        <h2>Multiplex Biotech Pvt Ltd (Pheromones)</h2>
                    </div>
