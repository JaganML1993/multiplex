...
<section class="page-title-area text-white bg_cover desktop-view" style="background-image: url({{ asset('images/founder-management-header-img4.jpg') }});">
    <div class="container">
        <!--======  Page-title-Inner ======-->
...
<section class="mobile-view">
    ...
    <section class="page-title-area text-white bg_cover" style="background-image: url({{ asset('images/founder-management-header-img4.jpg') }});">
        <div class="container">
            <!--======  Page-title-Inner ======-->
            <div class="page-title-inner text-center">
                <h1 class="page-title">Founder & Management</h1>
    ...
    <div class="container pad-top-150">
        <div class="row align-items-xl-center vm-bg-color vision-row">
            ...
            <div class="col-xl-6 col-lg-12">
                <!--=== Hero Image Box ===-->
                <div class="hero-image-box d-xl-block wow fadeInRight management-image" data-wow-delay=".75s">
                    <img src="{{ asset('images/mg-shetty-new2.png') }}" alt="Hero Image">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container pad-top-150">
        <div class="row align-items-xl-center">
            <div class="col-xl-6 col-lg-12">
                <!--=== Hero Image Box ===-->
                <div class="hero-image-box d-xl-block wow fadeInRight management-image" data-wow-delay=".75s">
                    <img src="{{ asset('images/nm-shetty-new2.png') }}" alt="Hero Image">
                </div>
            </div>
