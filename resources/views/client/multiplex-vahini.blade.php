...
<html lang="zxx">
    <head>
        ...
        <!--====== Title ======-->
        <title>Multiplex Vahini - Multiplex Group</title>
        <!--====== Favicon Icon ======-->
                                ...
                                <div class="tab-content wow fadeInUp">
                                    <div class="tab-pane fade show active">
                                        <div class="content-box">
                                            <p>Multiplex Vahini, a bi-monthly agriculture magazine is an initiative of Multiplex Group’s extension activity. Vahini provides scientific know how on sustainable farming methods, Package of practices for season specific crops and researched articles. Farmers refer and adopt crop management techniques based on our technical journals.</p>
                                            <p>Multiplex Vahini comprehends scientific information on sustainable farming. It aims to hand hold farmers throughout the crop cycle to manage pests, diseases and nutrients for improved quality and quantity of the produce.</p>
											<p>We have included a dedicated space in the magazine to provide updates from the Department of Agriculture, Government of Karnataka. It also comprehends relevant information on policy changes and updates on trends in agriculture technology.</p>
