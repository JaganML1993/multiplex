...
<html lang="zxx">
    <head>
        ...
        <!--====== Title ======-->
        <title>Group of Companies - Multiplex Group</title>
        <!--====== Favicon Icon ======-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="features-content-box mb-50 wow fadeInRight">
                            ...
                            <p class="mb-35">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <!--====== Features Image Box ======-->
                        <div class="features-image-box mb-50 wow fadeInLeft">
                            <img src="assets/images/group/mac.png" alt="Group of companies">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!--====== Features Content Box ======-->
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-lg-6">
                        <!--====== Features Image Box ======-->
                        <div class="features-image-box mb-50 wow fadeInLeft">
                            <img src="assets/images/group/mm.png" alt="Group of companies">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <!--====== Features Image Box ======-->
                        <div class="features-image-box mb-50 wow fadeInLeft">
                            <img src="assets/images/group/mbt.png" alt="Group of companies">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!--====== Features Content Box ======-->
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-lg-6">
                        <!--====== Features Image Box ======-->
                        <div class="features-image-box mb-50 wow fadeInLeft">
                            <img src="assets/images/group/mfca.png" alt="Group of companies">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <!--====== Features Image Box ======-->
                        <div class="features-image-box mb-50 wow fadeInLeft">
                            <img src="assets/images/group/mug.png" alt="Group of companies">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!--====== Features Content Box ======-->
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-lg-6">
                        <!--====== Features Image Box ======-->
                        <div class="features-image-box mb-50 wow fadeInLeft">
                            <img src="assets/images/group/mystique.png" alt="Group of companies">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-lg-6">
                        <!--====== Features Image Box ======-->
                        <div class="features-image-box mb-50 wow fadeInLeft">
                            <img src="assets/images/group/msff.png" alt="Group of companies">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <!--====== Features Image Box ======-->
                        <div class="features-image-box mb-50 wow fadeInLeft">
                            <img src="assets/images/group/mf.png" alt="Group of companies">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!--====== Features Content Box ======-->
                        <div class="features-content-box mb-50 wow fadeInRight">
                            <div class="section-title mb-20">
                                <h2>Multiplex Fertlizers Pvt. Ltd.</h2>
                            </div>
                            <p class="mb-35">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
							standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. 
							It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. </p>
