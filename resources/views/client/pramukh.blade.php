...
<html lang="zxx">
    <head>
        ...
        <!--====== Title ======-->
        <title>Pramukh - Fertlizers - Multiplex Group</title>
        <!--====== Favicon Icon ======-->
    ...
    <body>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="cta-content-box text-white mb-50 wow fadeInLeft">
                            ...
                            <p class="mb-30">Sed ut perspiciatis unde omnis isnatu volunteer
                                accusantium doloremque laudantium, omnis isnatu volunteer perspiciatis.</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!--======  CTA Image Box  ======-->
                        <div class="cta-image-box wow fadeInRight">
                            <img src="assets/images/about-bg-2.jpg" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
				    <div class="col-xl-6 col-lg-6">
                        <!--====== Sidebar Widget Area ======-->
                            <div class="sidebar-widget product-back-img widget-service-nav gray-bg mb-30 wow fadeInUp">
                                <div class="block-image wow fadeInDown rad10"><img src="assets/images/bg33.jpg" alt="Service Image"></div>
                            </div>
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 padprod">
                        ...
                        <div class="service-info-wrapper pr-lg-40 wow fadeInDown">
                            <!-- <h2 class="title">Yard Cleaning</h2>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium
                                ...
                                est, qui dolorem ipsum quia dolo</p>
                            <div class="block-image wow fadeInDown"><img src="assets/images/service/single-service-1.jpg" alt="Service Image"></div> -->
                            <h3>Pramukh</h3>
                            <p>Unde omnis iste natus error voluptatem accusantium doloremque laudantium totam rem aperiam 
							eaque quae abillo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. 
							Nemenim spsam voluptatem quia voluptas sit aspernatur aut odit fugit, sed quia consequunture.</p>
                            <!-- <ul class="check-style-one mb-60">
                                ...
                                <li><i class="far fa-check"></i>Sidewalk Clearing</li>
                                <li><i class="far fa-check"></i>Snow Hauling & Stacking</li>
                            </ul> -->
                            <!-- <div class="row">
                                <div class="col-md-6">
                                    <div class="block-image wow fadeInLeft"><img src="assets/images/service/single-service-2.jpg" alt="Service Image"></div>
                                </div>
                                <div class="col-md-6">
                                    <div class="block-image wow fadeInRight"><img src="assets/images/service/single-service-3.jpg" alt="Service Image"></div>
                                </div>
                            </div> -->
                        </div>
                    </div>
				...
				<div class="row">
                    <div class="col-xl-6 col-lg-6 padprod">
                        <div class="service-info-wrapper pr-lg-40 wow fadeInDown">
                            <h3>Benefits</h3>
                            <ul class="check-style-one mb-60">
                                <li><i class="fa fa-check"></i>Nemenim spsam voluptatem quia.</li>
                                <li><i class="fa fa-check"></i>Awards Winning & Professional Team Member</li>
                                <li><i class="fa fa-check"></i>Sidewalk Clearing</li>
                                <li><i class="fa fa-check"></i>Snow Hauling & Stacking</li>
                            </ul>
                        </div>
                    </div>
					<div class="col-xl-6 col-lg-6 padprod">
        ...
        <section class="project-details-section prod-spec pt-10">
            <div class="container">
                <div class="project-details-wrapper pb-10">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="project-info-widget mb-30 wow fadeInRight">
                                <div class="info-content">
                                    <h6 style="color:#fff;">Specification</h6>
                                    <ul>
                                        <li><span class="title">Available Packing</span><span class="text">10g</span></li>
                                        <li><span class="title">Crop</span><span class="text">All Crops</span></li>
                                        <li><span class="title">Dosage & Methods of Application</span><span class="text">Dissolve 1g in 50 litres of water and spray on leaves & bunches</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
				    <div class="col-xl-6 col-lg-6">
                           <div class="embed-responsive embed-responsive-16by9">
							  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/W3P9deLFkk8?rel=0" allowfullscreen></iframe>
						   </div>
                    </div>
					<div class="col-xl-6 col-lg-6 prod-cta-bn">
                            <div class="menu-button d-xl-block">
                                <a href="#" class="main-btn primary-btn">Download Catalog</a>
                            </div>
							<br/>
							<div class="menu-button d-xl-block">
