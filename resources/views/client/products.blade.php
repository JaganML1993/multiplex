...
<html lang="zxx">
    <head>
        ...
        <!--====== Title ======-->
        <title>Our Products - Multiplex Group</title>
        <!--====== Favicon Icon ======-->
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="features-thumb-item-two mb-40 wow fadeInDown" data-wow-delay=".2s">
                            <div class="thumb">
                                <img src="assets/images/products/fertilizers.jpg" alt="Image">
                            </div>
                            <br/>
							<div class="padc01">
                                <h5 class="title">Fertlizers</h5>
                                <p>Sed perspiciatis unde omnis
                                    volunteer accusantium, doloremque laudantium totam rem apeira.</p>
                            </div>
							<br/>
							<div class="menu-button d-xl-block">
                                <a href="fertilizers.html" class="main-btn primary-btn">Know More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="features-thumb-item-two mb-40 wow fadeInDown" data-wow-delay=".2s">
                            <div class="thumb">
                                <img src="assets/images/products/growth-regulators.jpg" alt="Image">
                            </div>
                            <br/>
							<div class="padc01">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="features-thumb-item-two mb-40 wow fadeInDown" data-wow-delay=".2s">
                            <div class="thumb">
                                <img src="assets/images/products/bio-products.jpg" alt="Image">
                            </div>
                            <br/>
							<div class="padc01">
					...
					<div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="features-thumb-item-two mb-40 wow fadeInDown" data-wow-delay=".2s">
                            ...
                            <br/>
							<div class="padc01">
                                <h5 class="title">Adjuvants & PH Balancer</h5>
                                <p>Sed perspiciatis unde omnis
                                    volunteer accusantium, doloremque laudantium totam rem apeira.</p>
                            </div>
							<br/>
					...
					<div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="features-thumb-item-two mb-40 wow fadeInDown" data-wow-delay=".2s">
                            <div class="thumb">
                                <img src="assets/images/products/pesticides.jpg" alt="Image">
                            </div>
                            <br/>
							<div class="padc01">
